...
public class AchievementDbHelper extends SQLiteOpenHelper {
    private static final String DB_NAME="cv10";
    private static final int DB_VERSION=1;

    private static final String TABLE_NAME="achievements";

    private static final String COL1="achievement";
    ...
    public AchievementDbHelper(Context context){
        ...
        Log.i("DB Message","Achievement Database Created");
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL(CREATE_QUERY);
        Log.i("DB Message","Achievement Table Created");
    }
    ...
    public void insertData( String pass1, SQLiteDatabase db){
        ...
        Log.i("DB Message","1 data inserted in Achievement");
    }
